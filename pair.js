...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            email: 'darkmanterrible@gmail.com', // Your Mega A/c Email Here
            password: '9Rcu6hcF.iTQ_S5@@' // Your Mega A/c Password Here
        }).ready;
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'GoJo-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of GoJo-xmd.
2️⃣ Stay updated with our latest releases and support.
3️⃣ Enjoy seamless WhatsApp automation! 🤖  

🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://chat.whatsapp.com/IbqroBdjYR45Ep0wPNzJoQ) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [DARKMAN226 GitHub Repo](https://github.com/DARKMAN226/GoJo-xmd.git)  

🚀 _Thanks for choosing GoJo-xmd — Let the automation begin!_ ✨`;
